...
public class MicrowaveBlock extends Block implements IHasModel
{
	public MicrowaveBlock(String name, Material material)
	{
		super(material);
	...
	public static final AxisAlignedBB AABB = new AxisAlignedBB(0.1875D, 0, 0.1875D, 0.8125D, 0.5D, 0.8125D);
